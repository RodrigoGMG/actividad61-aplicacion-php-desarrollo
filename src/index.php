...
A medida que avanza se va consturyendo cada fila de la tabla HTML con todos los campos del empleado, hasta completar todos los registros*/
	...
	while($fila = $resultado->fetch_array()) {
		...
		echo "<td>".$fila['Anio_fabricacion']."</td>\n";
		echo "<td>".$fila['Fiabilidad']."</td>\n";
...
Este forma de pasar el dato se conoce como: método GET*/
		...
		echo "<a href=\"delete.php?id=$fila[id]\" onClick=\"return confirm('¿Está segur@ que desea eliminar este coche?')\" >No disponible</a></td>\n";
		echo "</td>";
		echo "</tr>\n";
	}//fin mientras
 }//fin si
?>
	...
	<footer>
    	Created by Rodrigo Gomez Marin &copy; 2025
  	</footer>
</div>
</body>
</html>
